...
public class FilterByRowKeySuit {
    ...
    public void testGetRowKey(){
        ...
        Date date = new Date();
        try {
           date = simpleDateFormat.parse("2017-08-14 17:41:24");
        ...
        Date date1 = new Date();
        try {
            date1 = simpleDateFormat.parse("2017-08-14 17:45:17");
        } catch (ParseException e) {
            e.printStackTrace();
        }
